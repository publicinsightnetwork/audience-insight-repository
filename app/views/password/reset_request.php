...
|--------------------------------------------------------------------------
| HTML password change request page for AIR2
*/
?>
<!DOCTYPE html
...
<head>
<title>AIR2 | Reset Password</title>
...
<?php else : ?>
    <table border="0" cellpadding="5">
        <tr><th><?php echo $email_header; ?></th></tr>
        <tr><td><?php echo $email_content; ?></td></tr>
