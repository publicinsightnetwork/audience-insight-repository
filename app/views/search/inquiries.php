        ...
        var resultTpl = new Ext.XTemplate(
           '<tpl for=".">',
            '<div class="air2-search-result2">',
             ...
             '</tpl>',
             '<div class="air2-search-excerpt">{summary}</div>',
             '<table class="air2-search-inq">',
              '<tr><th>Status:</th><td><span class="air2-inq-status-{inq_status}">{status}</span></td></tr>',
              '<tr><th>Tags:</th><td>',
              '<tpl for="tag"',
               '<span class="tag">',
              ...
              '</tpl>',
              '</td></tr>',
              '<tr><th>Created:</th><td>{[AIR2.Format.dateHuman(values.inq_cre_dtim)]}<tpl if="values.creator_fl"> by </tpl>',
              ...
              '</tpl>',
              '</td></tr>',
              '<tr><th>Updated:</th><td>{[AIR2.Format.dateHuman(values.inq_upd_dtim)]}</td></tr>',
              '<tr><th>Published:</th><td>{[AIR2.Format.date(values.inq_publish_date)]}</td></tr>',
             '</table>',
            '</div>',
           '</tpl>'
        );
