 ...
 * @package default
 */
class AAPI_Outcome_Tag extends AIRAPI_Resource {
    ...
    protected function air_query($args=array()) {
        ...
        $q = Doctrine_Query::create()->from('TagOutcome t');
        $q->where('t.tag_xid = ?', $out_id);
    ...
    protected function air_create($data) {
        ...
        $rec = TagSource::create_tag('TagOutcome', $this->parent_rec->out_id, $input, $use_id);
        if (!$rec) {
