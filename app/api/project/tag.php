 ...
 * @package default
 */
class AAPI_Project_Tag extends AIRAPI_Resource {
    ...
    protected function air_query($args=array()) {
        ...
        $q = Doctrine_Query::create()->from('TagProject t');
        $q->where('t.tag_xid = ?', $prj_id);
    ...
    protected function air_create($data) {
        ...
        $rec = TagSource::create_tag('TagProject', $this->parent_rec->prj_id, $input, $use_id);
        if (!$rec) {
