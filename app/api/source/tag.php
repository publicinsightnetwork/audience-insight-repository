 ...
 * @package default
 */
class AAPI_Source_Tag extends AIRAPI_Resource {
    ...
    protected function air_query($args=array()) {
        ...
        $q = Doctrine_Query::create()->from('TagSource t');
        $q->where('t.tag_xid = ?', $src_id);
    ...
    protected function air_create($data) {
        ...
        $rec = TagSource::create_tag('TagSource', $this->parent_rec->src_id, $input, $use_id);
        if (!$rec) {
