...
class TagOutcome extends Tag {
    ...
    public function setUp() {
        ...
        $this->hasColumn('tag_ref_type', 'string', 1, array('default' => 'O'));
    ...
    public function user_may_read(User $u) {
        return $this->Outcome->user_may_read($u);
    }
    ...
    public function user_may_write(User $u) {
        return $this->Outcome->user_may_write($u);
    }
