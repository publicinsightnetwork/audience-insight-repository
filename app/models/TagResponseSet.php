 ...
 * @package default
 */
class TagResponseSet extends Tag {
    ...
    public function setUp() {
        ...
        $this->hasColumn('tag_ref_type', 'string', 1, array('default' => 'R'));
    ...
    public function user_may_read(User $u) {
        return $this->SrcResponseSet->user_may_read($u);
    }
    ...
    public function user_may_write(User $u) {
        return $this->SrcResponseSet->user_may_write($u);
    }
