...
require_once 'SrcPhoneNumber.php';
require_once 'trec_utils.php';

class TestSrcPhoneNumber extends SrcPhoneNumber {
    public static $UUID_COL = 'sph_uuid';
    ...
    function preInsert() {
        trec_make_new($this);
        if (is_null($this->sph_src_id)) $this->sph_src_id = '123';
    }
