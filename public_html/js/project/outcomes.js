/***************
 * Project Outcomes Panel
 */
AIR2.Project.Outcomes = function () {
    var editTemplate, len, orgObj, p, prjObj, template;
    ...
    // get an org and prj for creating new
    orgObj = null;
    prjObj = null;

    len = AIR2.Project.ORGDATA.radix.length;

    if (len) {
        orgObj = AIR2.Project.ORGDATA.radix[len - 1];
        prjObj = AIR2.Project.BASE.radix;
    }
    ...
    p = new AIR2.UI.Panel({
        ...
        storeData: AIR2.Project.OUTDATA,
        url: AIR2.Project.URL + '/outcome',
        itemSelector: '.outcome-row',
        tpl: template,
        editModal: {
            title: 'Project PINfluence',
